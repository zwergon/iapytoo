...
def parse_args():
    ...
    exclusive_group.add_argument("--yaml", type=str, help="Path to the YAML configuration file.")
    ...
    param_group.add_argument("--tracking-uri", type=str, help="Tracking URI (optional).")
    ...
    if args.yaml is None and (args.run_id is None or args.epochs is None):
        parser.error("If --yaml is not provided, both --run-id and --epochs are required.")
